...
run_tool(["user", "create", "student", "StudentPass2026!", "--realm=ESC8LAB.LOCAL"])
run_tool(["user", "create", "svc_http", "HTTPServPass123!", "--realm=ESC8LAB.LOCAL"])
run_tool(["spn", "add", "HTTP/esc8-web.esc8lab.local:80", "svc_http"])
run_tool(["spn", "add", "HTTP/esc8-web.esc8lab.local", "svc_http"])
run_tool(["user", "create", "svc_enroll", "EnrollSvcPass123!", "--realm=ESC8LAB.LOCAL"])
run_tool(["spn", "add", "HOST/esc8-enroll.esc8lab.local", "svc_enroll"])
